...
#    Notes:
#       - tested with python3
#       - updated file string in main to match folder's test file
#       - two functions were created as helpers for actions
#       - updated to 'from itertools import combinations', optimization
#       - final output from testing this was '2' consistently
#       - output photo shows generated output plus finalList
